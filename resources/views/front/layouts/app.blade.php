        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    ...
                    <div class="justify-content-center" style="text-align: center;"><a  style="text-decoration: none;" href="{{ route('front.portfolio.show',['id' => $portfolio->id]) }}">{{ $portfolio->name }}</a></div>
                </div>
                @endforeach
            </div>
        </div>
